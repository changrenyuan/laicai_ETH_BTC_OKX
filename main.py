...
架构：
- lifecycle/ 下的模块负责编排
- core/risk/strategy/execution/ 等模块保持不变
- main.py 只负责调用 lifecycle 模块
"""
...
class QuantEngine:
    ...
    async def run(self):
        ...
        try:
            ...
            # Phase 4: BuildContext - 构建Context
            build_context = BuildContext()
            self.components["context"] = build_context.run()
            
            # Phase 5: Register - 注册模块
